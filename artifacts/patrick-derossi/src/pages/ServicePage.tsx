...
const TESTIMONIALS = [
  { text: "Patrick is a legend! I needed some drafting done for a granny flat, and he nailed it. He worked quickly but didn't cut any corners. The design was spot on, and even my builder commented on how clear and detailed the plans were.", name: "Mark O'Sullivan", role: 'Owner Builder — Rockingham', image: 'https://randomuser.me/api/portraits/men/32.jpg' },
  { text: "We used Patrick for a new duplex design, and he was fantastic! Super professional but also really easygoing. He had great ideas to maximise the space, and his attention to detail was incredible. Can't recommend him enough!", name: 'Priya & John Williams', role: 'Duplex Design — Cannington', image: 'https://randomuser.me/api/portraits/women/44.jpg' },
  { text: "Patrick efficiently completed all my applications at a minimal cost and within a remarkably short timeframe. Despite being unable to find anyone willing to meet my deadline elsewhere, Patrick delivered exceptional results.", name: 'Sarah & Michael Johnson', role: 'Custom Family Home — Claremont', image: 'https://randomuser.me/api/portraits/women/68.jpg' },
  { text: "From concept to council approval, Patrick was with us every step of the way. His knowledge of the R-Codes saved us weeks of back-and-forth. The finished drawings were beautifully detailed — our builder was very impressed.", name: 'James & Rebecca Thornton', role: 'Double Storey Home — Nedlands', image: 'https://randomuser.me/api/portraits/men/46.jpg' },
  { text: "Absolutely outstanding service. We had a challenging corner block with strict setback requirements, and Patrick navigated everything seamlessly. Our triplex is now approved and under construction. Highly recommended.", name: 'David & Lisa Nguyen', role: 'Triplex Development — Bayswater', image: 'https://randomuser.me/api/portraits/men/22.jpg' },
  { text: "Patrick's attention to detail is second to none. He picked up on issues with our brief that we hadn't even noticed, and the final design was better for it. The council approval came back first time with no modifications required.", name: 'Tom & Angela Bertelli', role: 'Custom Home — Applecross', image: 'https://randomuser.me/api/portraits/men/55.jpg' },
  { text: "We had been trying to get plans done for our renovation for months with no luck. Patrick quoted quickly, started within a week, and had concept plans to us within two weeks. Refreshingly efficient.", name: 'Karen Blackwood', role: 'Home Renovation — Mount Lawley', image: 'https://randomuser.me/api/portraits/women/29.jpg' },
  { text: "Patrick designed a granny flat for my elderly mother that is both beautiful and incredibly practical. He really listened to what she needed and delivered a design that exceeded our expectations in every way.", name: 'Rachel & Tim Lawson', role: 'Granny Flat Design — Floreat', image: 'https://randomuser.me/api/portraits/women/77.jpg' },
  { text: "Patrick handled our carport and alfresco approvals efficiently and professionally. We'd had another drafts person fail to get council approval twice — Patrick sorted it first time. We wouldn't use anyone else.", name: 'Greg Palermo', role: 'Carport & Alfresco — Victoria Park', image: 'https://randomuser.me/api/portraits/men/61.jpg' },
];
